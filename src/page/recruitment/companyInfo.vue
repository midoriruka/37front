<template>
    <div>
      <el-form ref="form" :model="fieldData" label-width="80px">
        ...
        <el-form-item label="工资发放周期" label-width="110px">
        ...
        <el-form-item label="所属行业">
          <el-select v-model="fieldData.companyIndu" placeholder="所属行业">
            <el-option v-for="(item,index) in companyIndus" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="公司性质">
          <el-select v-model="fieldData.companyNature" placeholder="公司性质">
            <el-option v-for="(item,index) in companyNatures" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
