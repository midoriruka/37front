    ...
    <div class="daypay-content">
      ...
      <div class="daypay-banner-pic">
        <mt-swipe :auto="4000" style="height: 240px">
          <mt-swipe-item>
            <img :src="bannerList.maxBannerOne" :alt="bannerList.maxBannerOneUrl" class="banner-img">
          </mt-swipe-item>
          <mt-swipe-item>
            <img :src="bannerList.maxBannerTwo" :alt="bannerList.maxBannerTwoUrl" class="banner-img">
          </mt-swipe-item>
          <mt-swipe-item>
            <img :src="bannerList.maxBannerThree" :alt="bannerList.maxBannerThreeUrl" class="banner-img">
          </mt-swipe-item>
        </mt-swipe>
      </div>
...
export default {
  ...
  data () {
    return {
      iconArr: ['../../static/index/1.png', '../../static/index/2-check.png', '../../static/index/3.png'],
      bannerList: {},
      bannerContentOne: {},
      bannerContent: 1,
      officeList: [],
  ...
  methods: {
    ...
    getHighRewardList (selectConditionFromDialog, isDialogClose) {
      ...
      this.axios({
        method: 'post',
        url: '/api/h5/getMaxCompanyOfficeList',
        headers: {
